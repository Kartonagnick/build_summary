...
//=== SHOW CONFIG-DATA =========================================================
    ...
    #define dSHOW_BI_COMPILER() \
        dPRAGMA_MESSAGE("gcc: " dSSTRINGIZE(dCOMPILER_VER)) 

#endif // !dHIDE_MSVC_MESSAGE

//==============================================================================
//==============================================================================
#endif // dBUILD_SUMMARY_GCC_USED_
