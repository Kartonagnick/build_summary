[![logo](docs/logo.png)](docs/docs.md "documantation")  

Description: build summary info  
Description: краткая информация о сборке  
...
Инструмент выводит в консоль информацию вида:  
```
1>------------------------------------[sample]
...
[Новости проекта](docs/changelog.md)  
